...
PrintWriter out=response.getWriter();
		...
		out.println("<div>");
		out.println("<h1 align=\"center\" class=\"title\">My Bank Book</h1>");
		
		
	    out.println("<form action =\"BankBookController\" method = \"Post\">");
	    out.println("<table width = \"100%\" border =\"0\"bgcolor=\" 33C6F1\">\r\n" + 
	    		"       <tr>\r\n" + 
	    		"            <th rowspan=\"2\" \"><h3>  Bank Book </h3> </th>\r\n" + 
		...
		ArrayList<Bank_book> catList = (ArrayList<Bank_book>) request.getAttribute("catList");
	    
	    int sno=1;
	    
	    for (Bank_book cat : catList) {
			out.println("<tr>");
		...
		int userid =(Integer)session.getAttribute("userid");
		 double balance = Bank_bookDao.closingBalance(userid);
		out.println(" <tr>");
